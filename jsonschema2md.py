...
class Parser:
    ...
    def __init__(
        ...
        omit_top_level_metadata: bool = False,
    ):
        """
        ...
        self.omit_top_level_metadata = omit_top_level_metadata
...
def main(
    ...
    show_examples,
    token,
    omit_top_level_metadata,
):
    """Convert JSON Schema to Markdown documentation."""
    parser = Parser(
        examples_as_yaml=examples_as_yaml,
        show_examples=show_examples,
        omit_top_level_metadata=omit_top_level_metadata,
    )
